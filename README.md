...
[![Go Report Card](https://goreportcard.com/badge/github.com/Aetrix27/makescraper)](https://goreportcard.com/report/github.com/Aetrix27/makescraper)
...
3. Open `README.md` in your editor and replace all instances of `Aetrix27` with your GitHub username to enable the Go Report Card badge.
